...
function ScrollHeightChange({ image, width, imageHeight }: ScrollHeightChangeProps) {
    ...
    useEffect(() => {
        ...
        const updateHeight = () => {
            ...
            setHeight(Math.max(Math.abs(newHeight), 100));
        };
...
function UTP() {
    return (
        <div className="relative w-full mt-[400px] flex min-h-screen flex-col items-center bg-[color:var(--light-background)]">
